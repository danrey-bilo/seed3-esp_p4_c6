...
Номера `#1`, `#2` на карточках различают одинаковые экземпляры эффектов.
...
изменения. Удержание педали 2 секунды внутри корпуса открывает действия и
INFORMATION с описанием/CPU. Удержание 1 секунду, затем выход за корпус переносит
...
для остальных предусмотрена OTHER. Кабинет занимает двойную ширину.

...
#define SPK_CHANNEL_CONFIG (AUDIO_CHANNEL_CONFIG_FRONT_LEFT | AUDIO_CHANNEL_CONFIG_FRONT_RIGHT)
#else
#define SPK_CHANNEL_CONFIG AUDIO_CHANNEL_CONFIG_NON_PREDEFINED
#endif

#if MIC_CHANNEL_NUM == 2
#define MIC_CHANNEL_CONFIG (AUDIO_CHANNEL_CONFIG_FRONT_LEFT | AUDIO_CHANNEL_CONFIG_FRONT_RIGHT)
#elif MIC_CHANNEL_NUM == 1
